...
(
  ...
  convert -size 1x1004 -page +116+3 gradient:black-white miff:-

  # Draw the color axis for main disk
  convert -size 884x484 -page +6+68 xc:none \
          -draw 'fill Red      line 110,60 880,60' \
          -draw 'fill Cyan     line 110,60   0,60' \
          -draw 'fill Blue     line 110,60  132,0' \
          -draw 'fill Lime     line 110,60  132,120' \
          -draw 'fill Magenta  line 110,60  748,0' \
          -draw 'fill Yellow   line 110,60 748,120' \
          miff:-
  ...
  do
    ...
    convert -size 52x14 -page "+$x+$y" xc:none \
...
montage MIFF:- +repage -background none -geometry +2+2 show montage.png:; exit
