...
#  seed_posweight - (0-1) - weights the positive seed similarity score 
#  seed_negweight - (0-1) - weights the negative seed similarity score
#  ngrams - int- allows ngram measurements for N terms
#
# Outputs:
