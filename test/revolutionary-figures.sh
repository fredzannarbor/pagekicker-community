...
bin/create-catalog-entry.sh --builder "yes" --booktitle "Test" --yourname "Fred" --jobprofilename "default" --import "no" --passuuid "$uuid" --seedfile "seeds/revolutionary_figures" --imprint "pagekicker"  --analyze_url "none"
