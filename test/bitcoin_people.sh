...
bin/create-catalog-entry.sh --builder "yes" --booktitle "Bitcoin People" --yourname "21 User" --jobprofilename "default" --import "yes" --passuuid "$uuid" --seedfile "seeds/bitcoin_people" --imprint "pagekicker"  --analyze_url "none" 
